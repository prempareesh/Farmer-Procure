          ...
          <div>
            ...
            <div className="text-left bg-[#FAF8F2] p-4 rounded-xl border border-gray-200 space-y-1.5 text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-[#1B4318] uppercase">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-md border border-[#E0ECE0] space-y-5 flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-600 leading-relaxed font-medium">
              Scanning the farmer's QR pass automatically verifies the token
              payload, confirms physical gate arrival, and triggers state
              transition to <strong>ARRIVED</strong> with a SHA-256 block hash.
            </p>
            ...
            {scanResult && (
              ...
              >
                ...
                <p className="text-[11px] text-gray-700">
                  ...
                  <strong>ARRIVED</strong>. Direct to Weighbridge Counter #2.
                </p>
              </motion.div>
            )}
          </div>
