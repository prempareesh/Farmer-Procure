...
import { Eye, TrendingUp, HelpCircle, AlertTriangle, Zap, CheckCircle2, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="mt-3 text-base text-gray-600 font-medium">
            From raw Mandi queue observation to cryptographic verification — an end-to-end AI workflow built for trust and speed.
          </p>
        </div>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 space-y-4">
                ...
                <div className="pt-2">
                  <h4 className="text-sm font-bold text-gray-900 mb-3">Key Operational Features:</h4>
                  <ul className="space-y-2.5">
                    {steps[activeStep].detailCard.bullets.map((bullet, bIdx) => (
                      <li key={bIdx} className="flex items-start gap-2.5 text-sm text-gray-700 font-medium">
              ...
              <div className="lg:col-span-5 bg-[#FAF8F2] rounded-2xl p-6 border border-[#E8E4D9]">
                <div className="space-y-4">
                  ...
                  <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-xs space-y-2">
                    <p className="text-xs text-gray-500 font-semibold">Engine Metric:</p>
                  ...
                  <div className="bg-[#1B4318] text-white p-4 rounded-xl space-y-2 font-mono text-xs">
                    <div className="text-white/60 text-[10px]"># Cryptographic Payload Hash</div>
