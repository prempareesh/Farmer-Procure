            ...
            {steps.map((s, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {idx < steps.length - 1 && (
                    <span className="text-gray-300 ml-1">ΓåÆ</span>
                  )}
                </button>
              );
            })}
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              <div className="flex-1 my-2">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-gray-500 font-medium">
                            FRM-2026-000123 ΓÇó Karnal, Haryana
                          </div>
                        </div>
                      </div>
                ...
                {/* STEP 07 ΓÇö PROCUREMENT STATUS UI */}
                {currentStepIndex === 6 && (
                  <div className="bg-[#FAFBF8] rounded-2xl p-5 border border-gray-200 space-y-4 font-sans select-none">
