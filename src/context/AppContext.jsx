      ...
      try {
        ...
        if (profilesData && profilesData.length > 0) {
          const formatted = profilesData.map((p) => ({
            ...
            district: p.district || "",
            state: p.state || "",
            address: p.address || [p.village, p.district, p.state].filter(Boolean).join(", "),
            role: p.role || "farmer",
      ...
      try {
        ...
        if (dbProfile) {
          matchedFarmer = {
            ...
            address:
              dbProfile.address ||
              [dbProfile.village, dbProfile.district, dbProfile.state]
                .filter(Boolean)
                .join(", "),
          ...
          .insert([
            {
              ...
              village: activeFarmerObj.village || "",
              district: activeFarmerObj.district || "",
              state: activeFarmerObj.state || "",
              role: "farmer",
            },
          ])
          .select()
